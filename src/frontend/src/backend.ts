...
export class Backend implements backendInterface {
    ...
    async addOrUpdateStockItem(arg0: Product, arg1: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addOrUpdateStockItem(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async completeOrder(arg0: OrderId): Promise<OrderId> {
        if (this.processError) {
            try {
    ...
    async getAllCurrentOrders(): Promise<Array<Order>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllCurrentOrders();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getStockStatus(arg0: ProductId): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async placeOrder(arg0: Array<Product>, arg1: Quantity, arg2: RoomNumber): Promise<OrderId> {
        if (this.processError) {
            try {
...
function from_candid_record_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        name: value.name,
        roomNumber: record_opt_to_undefined(from_candid_opt_n6(_uploadFile, _downloadFile, value.roomNumber))
    };
}
